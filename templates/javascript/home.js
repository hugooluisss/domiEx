$(document).ready(function(){
	...
	$("#frmRegistroTransportista").validate({
		debug: true,
		rules: {
		...
		submitHandler: function(form){
			...
			obj.add({
				...
				fn: {
					after: function(datos){
						if (datos.band){
							alert("Gracias, nosotros nos pondremos en contacto contigo");
							location.reload();
						}else{
							alert("No se guardó el registro, al parecer ya te encuentras registrado");
						}
					}
				}
			});
