$(document).ready(function(){
	...
	var ordenMap = jQuery.parseJSON($("#datosOrden").val());
	var mapPoint = undefined;
	
	mapPoint = new google.maps.Map(document.getElementById('dvMapaSeguimiento'), {
		center: {lat: ordenMap.origen_json.latitude, lng: ordenMap.origen_json.longitude},
		scrollwheel: true,
	...
	var origen = new google.maps.LatLng(ordenMap.origen_json.latitude, ordenMap.origen_json.longitude);
	var destino = new google.maps.LatLng(ordenMap.destino_json.latitude, ordenMap.destino_json.longitude);
